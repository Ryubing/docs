...
![manage user profiles](https://github.com/user-attachments/assets/e919b4be-61aa-4c3b-a58d-51af2a6e92f2)
...
_**Mode:**_  
Set to _Disabled_ by default. There are 3 modes:
- Disabled - Multiplayer functionality is disabled.
- RyuLDN - This enables standard connectivity with Ryujinx users over the internet ONLY.
...
![multiplayer settings](https://github.com/user-attachments/assets/75c9b9ff-af63-4a9a-884d-53c213ec4ff2)
...
`Enable Guest Internet Access` allows you to connect with a Switch console on the same network as your PC running Ryujinx, as long as the game supports LAN as well. See below for a list of games with a LAN mode.

![Lan Mode](https://github.com/user-attachments/assets/e750ced7-31b7-46a9-bd0d-ad075f3255fd)
